...
<body>
        ...
        <div class="modal-body">
          <form action="process.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
              <input type="reset" class="btn btn-success" name="clear" value="CLEAR">
          ...
          <div class="col-lg-3 col-md-4" style="border: 2px solid #198754">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
              <a href="assets/img/hk.jpg" class="gallery-lightbox">
                <img src="assets/img/hk.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit" style="background-color: white; border: 2px solid black; color: #198754; font-weight: bold; border-radius: 50px;" class="bg-success text-light">Send Message</button></div>
            </form>
  ...
  <div class="modal fade" id="reg_scholar" tabindex="-1" aria-labelledby="reg_scholar" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="reg_scholarLabel" required></h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="process.php" method="POST">
