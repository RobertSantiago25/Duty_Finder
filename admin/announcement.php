  ...
  <aside id="sidebar" class="sidebar bg-success">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link bg-success fw-bold text-light" href="announcement.php">
          <i class="bi bi-megaphone text-light"></i>
          <span class="btn btn-success fw-bold">ANNOUNCEMENT</span>
        </a>
    ...
    <div class="pagetitle ">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item btn btn-light text-dark">Announcement</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-md-11">
          <div class="card">
            <div class="card-header">
              <span class="fw-bold text-success">Announcement</span>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group  text-success fw-bold">
                      <label>Message</label>
                      <textarea name="message" class="form-control" style="height: 100px; resize: none;"></textarea>
                    </div>
                  </div>
                </div>
                <button type="submit" name="announce" class="btn btn-success btn-fill pull-right mx-1 mt-2  text-light fw-bold">Annouce</button>
                <!-- <a href="#" onclick="form.hidden = true; table.hidden = false;" class="link text-success pull-right mx-2 pt-2"><u>Manage Spaces</u></a> -->
                      ...
                      <td>
                        <div class="input-group-append">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#updateModal<?php echo $announcement['id'] ?>">Update</a>
                            <a class="dropdown-item" onclick="return confirm('Do you want to Delete this Announcement?')" href="delete_announce.php?id=<?php echo $announcement['id'] ?>">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
                        ...
                        <div class="modal-content">
                          <form action="process.php?id=<?php echo $announcement['id'] ?>" method="POST">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" name="upd_announcement" class="btn btn-success">Save changes</button>
                            </div>
                          </form>
                        </div>
                      </div>
