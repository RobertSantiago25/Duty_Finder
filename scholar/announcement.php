  ...
  <aside id="sidebar" class="sidebar bg-success">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item  ">
        ...
        <a class="nav-link bg-success text-light " href="announcement.php">
                  ...
                  <div class="modal-content">
                    <form action="process.php?id=<?php echo $announcement['id'] ?>" method="POST">
                      <div class="modal-header">
                        ...
                        <button type="button" readonly class="close" data-bs-dismiss="modal" aria-label="Close">
                        ...
                        <div class="row">
                          ...
                          <label for="">Title</label>
                            <div class="input-group">
                              ...
                              <input type="text" name="title" class="form-control" readonly value="<?php echo $announcement['title'];?>">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label>Message</label>
                              <textarea name="message" class="form-control" readonly style="height: 100px; resize: none;"><?php echo $announcement['message'] ?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
