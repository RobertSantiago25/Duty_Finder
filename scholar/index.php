...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="header fixed-top d-flex align-items-center" style="background: #198754 ;">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item  text-dark btn btn-light bi-bi-person">Search </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
